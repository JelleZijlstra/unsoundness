"""
This example is conceptually the same as mutable_inplace, but it adds another layer of indirection to expose another cause
for the.same unsoundness.

Pyright seems to have a feature where it ignores annotations in favor of the (narrower) inferred type. This causes the same unsoundness
